...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "format_week")
public class FormatWeek {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "format_week_id")
    ...
    @OneToMany(mappedBy = "formatWeek", orphanRemoval = true, cascade = jakarta.persistence.CascadeType.ALL)
    private List<FormatWeekCell> cells = new ArrayList<>();
}
