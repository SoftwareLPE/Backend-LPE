...
import com.example.backend_sistema_LPE.service.UserAdminService;
...
public class UserAdminController {
    ...
    @GetMapping
    public Page<UserTableDTO> getUsersForTable(
    ...
    public ResponseEntity<Void> deleteUser(@PathVariable Long userId, Authentication authentication) {
        ...
        if (authentication != null && authentication.getPrincipal() instanceof com.example.backend_sistema_LPE.security.UserPrincipal principal) {
